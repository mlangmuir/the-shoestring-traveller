        ...
        {!isLoading
            ? <Wrapper>
                ...
                <SitesDiv>
                    ...
                    <SiteDiv>
                        <a href="https://secretflying.com" target="_blank" rel="noreferrer">
                    ...
                    <SiteDiv>
                        <a href="https://skyscanner.com" target="_blank" rel="noreferrer">
                    ...
                    <SiteDiv>
                        <a href="https://couchsurfing.com" target="_blank" rel="noreferrer">
                    ...
                    <SiteDiv>
                        <a href="https://hostelworld.com" target="_blank" rel="noreferrer">
                    ...
                    <SiteDiv>
                        <a href="https://booking.com" target="_blank" rel="noreferrer">
                    ...
                    <SiteDiv style={{border: "none"}}>
                        <a href="https://getyourguide.com" target="_blank" rel="noreferrer">
